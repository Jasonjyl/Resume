...
import com.betterjason.bean.Specialty;
...
public class SpecialtyDaoImp implements BaseDao<Specialty> {
    ...
    private static final String SQL_INSERT = "insert into homepage_specialty(userid,name,description) values(?,?,?)";
    private static final String SQL_FIND_BY_USERID = "select * from homepage_specialty where userid=?";
