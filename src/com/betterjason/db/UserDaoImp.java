package com.betterjason.db;

import com.betterjason.bean.User;
import com.betterjason.util.DBUtil;

import java.sql.*;

public class UserDaoImp implements BaseDao<User>{
    private static final String SQL_INSERT = "insert into homepage_user(name,age,city,address,email,phone,weixin,qq,weibo,sex,description) values(?,?,?,?,?,?,?,?,?,?,?)";
    private static final String SQL_FIND_BY_USERID = "select * from homepage_user where id=?";
