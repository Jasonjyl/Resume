...
import com.betterjason.bean.Skill;
...
public class SkillDaoImp implements BaseDao<Skill> {
    ...
    private static final String SQL_INSERT = "insert into homepage_skill(userid,keywords) values(?,?)";
    private static final String SQL_FIND_BY_USERID = "select * from homepage_skill where userid=?";
